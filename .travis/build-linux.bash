...
export CFLAGS="$CFLAGS -fuse-ld=${LINKER} -Wno-error=old-style-cast "

cmake .. -DCMAKE_INSTALL_PREFIX=/usr -DWITH_WERROR=OFF -DBUILD_LLVM_SUBMODULE=OFF -DUSE_COTIRE=OFF -DLLVM_DIR=llvmlibs/lib/cmake/llvm/ -DUSE_NATIVE_INSTRUCTIONS=OFF \
